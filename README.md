...
**AI & LLM:** Groq · RAG Pipelines · Prompt Engineering · Anthropic Claude  
**Database & Auth:** Supabase (PostgreSQL) · Row Level Security · Edge Functions  
**DevOps:** Railway · GitHub Actions · Sentry · Docker  
**Automation:** Make.com · Zapier · n8n · OpenAI · Airtable · Notion  
**Data Engineering:** DLT · dbt · PostgreSQL · SQLAlchemy · FastAPI  
**Vector Search & RAG:** Pinecone · Gemini Embeddings · LangChain · Chunking strategies  
**AI Agents & MCP:** Claude · Groq · LangGraph · MCP servers · Prompt Engineering

## 💼 What I Build
- **Full-stack mobile apps** — end to end from camera to backend to database
